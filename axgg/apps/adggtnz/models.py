...
class ViewLand(models.Model):
    regdate = models.DateTimeField(blank=True, null=True)
    rowuuid = models.CharField(primary_key=True, max_length=80)
    farmermobile = models.CharField(max_length=60, blank=True, null=True)
    size = models.DecimalField(max_digits=10, decimal_places=3, blank=True, null=True)
    primaryuse = models.CharField(max_length=9, blank=True, null=True)
    primaryuseoth = models.TextField(blank=True, null=True)
    ownership = models.IntegerField(blank=True, null=True)
    ownershipoth = models.TextField(blank=True, null=True)
    tenuresys = models.IntegerField(blank=True, null=True)
    tenuresysoth = models.TextField(blank=True, null=True)
